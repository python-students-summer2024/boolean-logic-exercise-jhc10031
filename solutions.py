...
def is_sweltering():
    ...
    temperature = int(input("What is the current temperature in Fahrenheit?"))
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humidity = input("is it humid currently?").lower()
...
def is_cool_and_nice():
    ...
    """
    # write your code for this function below this line.
    if is_sweltering() == False and is_warm() == False and is_humid() == False and is_inclement() == False:
       return True
    else:
       return False
